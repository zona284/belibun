...
//		updateUI(true);
			...
			/*String personName = "Selamat Datang di Kebunku\nPenuh dengan BUAH!";
		...
		new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                final Intent mainIntent = new Intent(MainActivity.this, UserPanel.class);
	...
	public void onClick(View v) {
		...
		case R.id.btn_sign_out:
			...
			signOutFromGplus();
/*			Intent intent = new Intent(v.getContext(), UserPanel.class);
